...
for i in range(total):
    ...
    files = f"../gm2fr/simulation/data/alg_scan_{subrun}_{total}/simulation.root",
    tags = f"alg_scan_{subrun}_{total}",
...
for subrun in range(1, total + 1):
  scan_hist = Histogram1D.load(f"../gm2fr/analysis/results/alg_scan_{subrun}_{total}/transform.root", "transform_f")
